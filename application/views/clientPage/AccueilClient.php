      ...
      <section class="hero" id="home" style="background-image: url('<?php echo base_url() ?>assets/images/green-banner-bg.jpg')">
        <div class="container">
          ...
          <figure class="hero-banner">
            <img src="<?php echo base_url() ?>assets/images/hero-banner-bg.png" width="820" height="716" alt="" aria-hidden="true" class="w-100 hero-img-bg">

            <img src="<?php echo base_url() ?>assets/images/delivery.png" width="700" height="637" loading="lazy" alt="Burger" class="w-100 hero-img">
          </figure>
